...
namespace CalorieTrackingApp.DAL.Migrations
{
    ...
    [Migration("20241013145254_UserMealDailyFoodsRecordTableCreate")]
    partial class UserMealDailyFoodsRecordTableCreate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CalorieTrackingApp.DAL.ValueObject.TotalCalorie", b =>
                {
                    ...
                    b.ToView("vwTotalCalorieView", (string)null);
                });
            ...
            modelBuilder.Entity("CalorieTrackingApp.DAL.ValueObject.UserMealBeverageCalorieGroup", b =>
                {
                    ...
                    b.ToView("vwUserMealBeverageCalorieGroup", (string)null);
                });
            ...
            modelBuilder.Entity("CalorieTrackingApp.DAL.ValueObject.UserMealDailyBeverageRecord", b =>
                {
                    ...
                    b.ToView("vwUserMealDailyBeverageRecord", (string)null);
                });

            modelBuilder.Entity("CalorieTrackingApp.DAL.ValueObject.UserMealDailyFoodsRecord", b =>
                {
            ...
            modelBuilder.Entity("CalorieTrackingApp.DAL.ValueObject.UserMealFoodCalorieGroup", b =>
                {
                    ...
                    b.ToView("vwUserMealFoodCalorieGroup", (string)null);
                });
